...
class joinlines:
  ...
  def run(self):
    ...
    curLayer.beginEditCommand( QString( "Join selected lines" ) )
    curLayer.changeGeometry( featids[ 0 ], newgeom )
    curLayer.endEditCommand()
    curLayer.beginEditCommand( QString( "Delete feature" ) )
    curLayer.deleteFeature( featids[ 1 ] )
    curLayer.endEditCommand()
